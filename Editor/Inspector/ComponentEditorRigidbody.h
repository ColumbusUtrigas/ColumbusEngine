...
namespace Columbus
{
	...
	private:
		static void _EditShape(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape, int id);

		static PhysicsShape* _EditBox(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape);
		static PhysicsShape* _EditCapsule(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape);
		static PhysicsShape* _EditCompound(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape);
		static PhysicsShape* _EditCone(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape);
		static PhysicsShape* _EditCylinder(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape);
		static PhysicsShape* _EditMultiSphere(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape);
		static PhysicsShape* _EditSphere(GameObject* Object, Rigidbody* RB, PhysicsShape*& Shape);
	public:
