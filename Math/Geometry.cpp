...
CREFLECT_STRUCT_BEGIN(iVector4, "")
	CREFLECT_STRUCT_FIELD(int, X, "")
	CREFLECT_STRUCT_FIELD(int, Y, "")
	CREFLECT_STRUCT_FIELD(int, Z, "")
	CREFLECT_STRUCT_FIELD(int, W, "")
CREFLECT_STRUCT_END()

CREFLECT_STRUCT_BEGIN(Box, "")
