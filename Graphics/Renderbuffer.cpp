...
namespace Columbus
{
	...
	void C_Renderbuffer::storage(C_RENDERBUFFER_FORMAT aFormat, const int aWidth, const int aHeight)
	{
		...
		switch (aFormat)
		{
		case C_RENDERBUFFER_DEPTH_16: format = GL_DEPTH_COMPONENT16; break;
		case C_RENDERBUFFER_DEPTH_24: format = GL_DEPTH_COMPONENT24; break;
		case C_RENDERBUFFER_DEPTH_32: format = GL_DEPTH_COMPONENT32; break;
		case C_RENDERBUFFER_DEPTH_24_STENCIL_8: format = GL_DEPTH24_STENCIL8; break;
		}
