...
namespace Columbus
{
	...
	namespace Import
	{
		...
		////////////////////////////////////////////////////////////////////////////
		bool ImporterModel::loadOBJ(const std::string aFile)
		{
			...
			while (std::getline(file, line))
			{
				...
				else if (line.substr(0, 2) == "f ")
				{
					...
					Vector3 deltaPos1 = ver2.pos - ver1.pos;
					Vector3 deltaPos2 = ver3.pos - ver1.pos;
		...
		////////////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////
		unsigned int ImporterModel::getCount() const
		{
			return mObjectsCount;
		}
		////////////////////////////////////////////////////////////////////////////
		std::vector<std::string> ImporterModel::getNames() const
		{
			return mNames;
		}
		////////////////////////////////////////////////////////////////////////////
		std::vector<std::vector<Vertex>> ImporterModel::getObjects() const
		{
			return mVertices;
		}
		////////////////////////////////////////////////////////////////////////////
		std::string ImporterModel::getName(unsigned int aID) const
		{
			return mNames.at(aID);
		}
		////////////////////////////////////////////////////////////////////////////
		std::vector<Vertex> ImporterModel::getObject(unsigned int aID) const
		{
